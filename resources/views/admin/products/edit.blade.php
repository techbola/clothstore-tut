                        ...
                        <div class="card-body">
                            <form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group pt-2">
                                    ...
                                    <input id="title" type="text" name="title" placeholder="Enter Product title" class="form-control" value="{{ $product->title }}" required>
                                </div>
                                <div class="form-group pt-2">
                                    <label for="price">Price</label>
                                    <input id="price" type="number" min="0" name="price" placeholder="Enter Price" class="form-control" value="{{ $product->price }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="editor1" name="description" required>{{ $product->description }}</textarea>
                                </div>
                                <div class="row pt-3">
                                    <div class="col-sm-12">
                                        <p class="text-left">
